...
$app->group('/admin', function (RouteCollectorProxy $admin) {
    ...
    $admin->get('/resellers', [DashboardController::class, 'adminResellers'])->setName('admin.resellers');
    $admin->get('/nodes', [DashboardController::class, 'adminNodes'])->setName('admin.nodes');
