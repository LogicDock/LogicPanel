...
class DatabaseController
{
    ...
    public function index(ServerRequestInterface $request, ResponseInterface $response): ResponseInterface
    {
        ...
        $query = Database::with(['user', 'service']);
    ...
    public function delete(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        try {
            ...
            match ($database->db_type) {
                'mysql' => $this->provisionerService->deleteMySQLDatabase($database->user_id, $database->id),
                'postgresql' => $this->provisionerService->deletePostgreSQLDatabase($database->user_id, $database->id),
                'mongodb' => $this->provisionerService->deleteMongoDBDatabase($database->user_id, $database->id),
            };
