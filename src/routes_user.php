...
return function (App $app) {
    ...
    $app->group('', function (RouteCollectorProxy $group) {
        ...
        // Database routes
        $group->get('/databases', [DatabaseController::class, 'index']); // GET ALL DBs
        $group->post('/databases', [DatabaseController::class, 'create']); // Create DB globally
    ...
    $app->group('/whmcs', function (RouteCollectorProxy $group) {
