...
// This file is included by index.php when port 967 is detected.
...
if ($path !== 'login') {
    ...
    if (!isset($_SESSION['lp_session_token']) || ($user_role !== 'admin' && $user_role !== 'root')) {
