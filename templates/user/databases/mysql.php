...
<div class="db-container">
    <div class="db-page-header">
        ...
        <p>Manage large amounts of information over the web easily.</p>
    </div>
    ...
    <div class="db-section">
        ...
        <!-- Hidden Type Field -->
        <input type="hidden" id="dbType" value="mysql">
                    ...
                    <tr>
                        ...
                        <td class="actions-col">
                            <div style="display:flex;gap:5px;justify-content:flex-end;">
                                <button class="btn btn-sm btn-secondary" title="Login to Adminer" onclick="loginToAdminer('server', '${db.host}', '${db.user}', '${db.password}', '${db.name}')">
                                    <i data-lucide="external-link" style="width:14px;height:14px;"></i>
                                </button>
                                <button class="btn btn-sm btn-secondary" title="Copy Connection String" onclick="copyConnString('mysql', '${db.host}', '${db.port}', '${db.user}', '${db.password}', '${db.name}')">
        ...
        */
        ...
        try {
            ...
            const res = await fetch(url, {
                method: 'POST',
                headers,
                body: JSON.stringify({ type: 'mysql' }) // No name provided, backend will generate
            });
            const data = await res.json();
            if (res.ok) {
