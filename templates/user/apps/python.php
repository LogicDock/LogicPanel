    ...
    <div class="db-section">
        ...
        <div class="db-form-group">
            ...
            <select id="appVersion" class="form-control">
                <option value="Python 3.11">Python 3.11 (Recommended)</option>
        ...
        <div id="advanced-section" class="github-deploy-section" style="display:none;">
            <div class="db-form-group">
                ...
                <small style="color:var(--text-secondary);font-size:11px;">Leave empty for default</small>
            </div>
            ...
            <div class="db-form-group">
                ...
                <input type="text" id="startCmd" class="form-control" placeholder="python app.py">
                <small style="color:var(--text-secondary);font-size:11px;">Leave empty for default</small>
            </div>
        </div>
...
<script>
    ...
    async function createApp() {
        ...
        try {
            ...
            if (res.ok) {
                if (githubRepo) {
                    showNotification('Deployment started! This can take up to 10 minutes.', 'info', 10000);
                } else {
