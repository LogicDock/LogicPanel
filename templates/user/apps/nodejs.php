...
<div class="db-container">
    ...
    <div class="db-section">
        ...
        <div class="db-form-group">
            ...
            <div class="input-group">
                <input type="text" id="appName" class="form-control" placeholder="my-app">
            </div>
            <small style="color:var(--text-secondary);font-size:12px;">Lowercase letters, numbers, and hyphens
                only.</small>
        </div>
        ...
        <div class="db-form-group">
            ...
            <small style="color:var(--text-secondary);font-size:11px;">Leave empty to use the default subdomain
                (appname.<?= $_SERVER['HTTP_HOST'] ?? 'cyberit.cloud' ?>).</small>
        </div>
        ...
        <div class="db-form-group">
            ...
            <select id="appVersion" class="form-control">
                <option value="Node.js 20 LTS">20.18.0 (Recommended)</option>
                <option value="Node.js 18 LTS">18.20.4</option>
                <option value="Node.js 16 LTS">16.20.2</option>
            </select>
        </div>
        ...
        <div id="github-section" class="github-deploy-section" style="display:none;">
            <div class="db-form-group">
                ...
                <small style="color:var(--text-secondary);font-size:11px;">Leave empty to create a blank app.</small>
            </div>
            ...
            <!-- Advanced Options (Optional) - Collapsible -->
            <div class="db-form-group">
            ...
            <div id="advanced-section" class="github-deploy-section" style="display:none;">
                ...
                <div class="db-form-group">
                    ...
                    <small style="color:var(--text-secondary);font-size:11px;">Leave empty for default: npm
                        install</small>
                </div>
                ...
                <div class="db-form-group">
                    ...
                    <small style="color:var(--text-secondary);font-size:11px;">Leave empty for default: node
                        server.js</small>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        async function loadApps() {
            ...
            try {
                ...
                <tr>
                    ...
                    <td>
                        <a href="${app.url || ('http://' + app.domain)}" target="_blank" style="font-family:monospace;background:var(--bg-input);padding:2px 6px;border-radius:3px;color:var(--primary-color);text-decoration:none;">
                            ${app.domain}
                        </a>
                    </td>
                    <td>
                    ...
                    <td class="text-right">
                        <button class="btn btn-sm btn-secondary" onclick="window.open('${app.url || ('http://' + app.domain)}', '_blank')" title="Open App"><i data-lucide="external-link"></i></button>
        ...
        async function createApp() {
            ...
            // Simple validation
            if (!/^[a-z0-9-]+$/.test(name)) {
                showNotification('Use lowercase letters, numbers, and hyphens only.', 'error');
                return;
            }
            ...
            try {
                ...
                if (res.ok) {
                    if (githubRepo) {
                        showNotification('Deployment started! This can take up to 10 minutes.', 'info', 10000); // 10s duration
                    } else {
