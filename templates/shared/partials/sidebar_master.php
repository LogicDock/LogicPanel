<aside class="lp-sidebar">
    ...
    <div class="lp-sidebar-user">
        <a href="<?= $base_url ?? '' ?>/settings/profile" class="lp-user-profile">
            <div class="lp-user-avatar" style="background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%);">
                R
            </div>
            <div class="lp-user-info">
                <div class="lp-user-name">Root Administrator</div>
                <div class="lp-user-role">Superuser</div>
            </div>
        </a>
